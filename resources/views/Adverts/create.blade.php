                        ...
                        <form action=" {{ route('advert.store') }} " method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-9 ">
                                    ...
                                    {{-- <textarea style="border-color: black;border-radius:15px" class="form-control"
                                        id="context" name="context" rows="7" cols="7"
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-4 col-sm-3 "
                                    style="font-size:large;color: #0f0f0f;font-family: 'Segoe UI'" for="discount_rate">Discount Rate </label>
                                <div class="col-md-8 col-sm-9 ">
