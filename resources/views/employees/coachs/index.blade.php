...
@section('content')
        ...
        <div class="right_col" role="main" style="background-color:#faf4ff">
            ...
            <div class="row  justify-content-center">
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Trainer Info<small>Data </small></h2>
                        ...
                        <div class="x_content">
                                            ...
                                            <tbody>
                                                @foreach ($coachs as $coach)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class=""
                                                                href="{{ route('coach.show', ['id' => $coach->id]) }}"><i
                                                                    class="fa fa-eye"></i></a>
                                                        </td>
                                                        <td>
                                                            <a class=""
                                                                href="{{ route('coach.edit', ['id' => $coach->id]) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                        </td>
                                                        <td>
                                                            <a class=""
                                                                href="{{ route('coach.delete', ['id' => $coach->id]) }}"><i
                            ...
                            <div class="row justify-content-center">
                                <div>
                                    <a class="btn btn-dark" href="{{ route('coach.create') }}" role="button"><i
                                            class="fa fa-plus"></i> Trainer
                                        Add</a>
                                </div>
                                <div>
                                    <a class="btn btn-dark" href="{{ route('coach.trashed') }}" role="button"><i
    ...
    @else
        <div class="right_col" role="main" style="background-color:#faf4ff">
            ...
            <div class="row justify-content-center">
                <div>
                    <a class="btn btn-dark" href="{{ route('coach.create') }}" role="button"><i class="fa fa-plus"></i>
                        Trainer Add</a>
                </div>
                <div>
                    <a class="btn btn-dark" href="{{ route('coach.trashed') }}" role="button"><i class="fa fa-trash"></i>
                        Deleted
                        Trainers</a>
                </div>
            </div>
